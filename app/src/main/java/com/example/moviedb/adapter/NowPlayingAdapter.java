...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.CardViewViewHolder> {
    ...
    public class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardViewViewHolder(@NonNull View itemView) {
            super(itemView);
            img_poster = itemView.findViewById(R.id.img_poster_card_upcom);
            lbl_title = itemView.findViewById(R.id.lbl_title_card_upcom);
            lbl_overview = itemView.findViewById(R.id.lbl_overview_card_upcom);
            lbl_release_date = itemView.findViewById(R.id.lbl_releasedate_card_upcom);
            cv = itemView.findViewById(R.id.cv_card_upcom);
